...
XMR-Stak is a universal Stratum pool miner. This miner supports CPUs, AMD and NVIDIA GPUs and can be used to mine the crypto currencies Kegcoin, Monero, Aeon and many more Cryptonight coins.
...
Besides [Kegcoin](https://kegcoin.org), following coins can be mined using this miner:
